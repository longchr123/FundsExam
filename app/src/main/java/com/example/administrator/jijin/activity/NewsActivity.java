...
import com.example.administrator.jijin.adapter.NewsListAdapter;
import com.example.administrator.jijin.bean.NewsItem;
import com.example.administrator.jijin.util.JsonUtil;
import com.example.administrator.jijin.util.TimeUtil;
import com.example.administrator.jijin.view.XListView;
...
public class NewsActivity extends Activity implements XListView.IXListViewListener, View.OnClickListener {
    ...
    public void downData(final int pages) {
        String httpUrl = Config.NEWS;//公司服务器
